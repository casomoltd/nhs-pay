...
export const DDRB_54_ENGLAND = new DocumentSource({
...
export const AFC_ENGLAND_2025 = new DocumentSource({
    ...
    issued: isoDate('2025-05-22'),
});

export const AFC_ENGLAND_2026 = new DocumentSource({
    issuer: 'the UK government',
    reference: 'written ministerial statement HCWS1340',
    url: 'https://questions-statements.parliament.uk/written-statements'
      + '/detail/2026-02-12/hcws1340',
    issued: isoDate('2026-02-12'),
...
export const AFC_WALES_2025 = new DocumentSource({
    issuer: 'the Welsh Government',
...
export const AFC_WALES_2026 = new DocumentSource({
    issuer: 'the Welsh Government',
 ...
 */
export const AFC_NI_2026 = new DocumentSource({
    ...
    nextExpected: isoDate('2026-04-01'),
    nextExpectedReason:
 ...
 * pair exists to stop.
 */
export const AFC_ENGLAND_SCALES_2025 = new DocumentSource({
...
export const AFC_ENGLAND_SCALES_2026 = new DocumentSource({
    issuer: 'NHS Employers',
 ...
 */
export const AFC_NI_2025 = new DocumentSource({
    issuer: 'the Department of Health (NI)',
 ...
 * either figure.
 */
export const AFC_W_02_2026 = new DocumentSource({
    issuer: 'NHS Wales',
 ...
 *  percentage. */
export const AFC_W_02_2025 = new DocumentSource({
    issuer: 'NHS Wales',
    reference: 'circular AfC(W) 02/2025',
    url: 'https://www.nhs.wales/files/pc-resources'
      + '/afc-w-02-2025-pdf-2-pdf/',
    issued: isoDate('2025-05-29'),
});
...
export const AFC_SCOTLAND = new DocumentSource({
    ...
    // the site for a year.
    nextExpected: isoDate('2027-03-01'),
    nextExpectedReason:
...
/**
 * The circular that sets NHS Scotland's full-time week to 36 hours
 * from 1 April 2026.
 *
 * A CONDITIONS circular, not a scales one, which is why it is not in
 * `AFC_SCALE_SOURCES`: it moves no salary. It is held because it is
 * the instrument behind a claim the site makes — the hourly rates,
 * and `hoursPerYear`, are computed on a week this document sets, and
 * before this record existed a consumer page carried its url as a
 * hand-typed string constant.
 *
 * Cited rather than the policy paper it is often confused with:
 * gov.scot's Fairer Scotland Duty assessment describes the reduction
 * as a proposal being assessed, where this one enacts it. A reader
 * checking the claim needs the instrument.
 *
 * No `nextExpected`: a handbook amendment is not on an annual cycle,
 * and inventing a date would assert a cadence the publisher does not
 * keep. `currencyAt` reports `unknown`, which is the honest answer.
 */
export const AFC_SCOTLAND_36_HOUR_WEEK = new DocumentSource({
    issuer: 'NHS Scotland',
    reference: 'circular PCS(AFC)2026/2',
    url: 'https://www.publications.scot.nhs.uk/files/pcs-afc-2026-02.pdf',
 ...
 */
export const PC_MD_1_2026_R2 = new DocumentSource({
    issuer: 'NHS Employers',
 ...
 */
export const PCS_DD_2026_01 = new DocumentSource({
    issuer: 'NHS Scotland',
...
export const PCS_DD_2026_02 = new DocumentSource({
    issuer: 'NHS Scotland',
 ...
 */
export const PCS_DD_2025_01_ADDENDUM = new DocumentSource({
    issuer: 'NHS Scotland',
    reference: 'circular PCS(DD)2025/01 addendum',
    url: 'https://www.publications.scot.nhs.uk/files/pcs2025-dd-01add.pdf',
    issued: isoDate('2025-11-26'),
});

export const MD_W_01_2026 = new DocumentSource({
    issuer: 'NHS Wales',
...
export const MD_W_01_2025 = new DocumentSource({
    issuer: 'NHS Wales',
    reference: 'circular M&D(W) 01/2025',
    url: 'https://www.nhs.wales/files/pc-resources'
      + '/md-w-01-25-pay-award-v3-pdf/',
    issued: isoDate('2025-08-05'),
});
 ...
 */
export const HSC_TC8_05_2025 = new DocumentSource({
    issuer: 'the Department of Health (NI)',
