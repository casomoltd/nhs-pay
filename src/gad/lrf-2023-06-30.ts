 ...
 * Spreadsheet", table 0-421, factors issued 30 June 2023.
 * Sheet x-421 · PDF p.26.
 *
 ...
 *
 * 1. Its *Version control* sheet shows x-421 last updated in
 ...
 * 2. Every cell of the x-421 sheet was diffed against the rows
 *    below — 11 rows — with **zero differences**.
 *
